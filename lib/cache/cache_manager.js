...
export function cacheReadsEnabled(force) {
  if (force) return true
  // Build workers must share the local file cache even when runtime cache is disabled.
  // Otherwise each SSG worker refetches the same Notion pages and quickly hits 429.
